...
- **2025-06-25**: FINAL FIX - Implemented CSP-bypass payment system that completely avoids script loading
  ...
  - **PAYMENT UX**: Added processing overlay with comprehensive style cleanup to prevent wallet interaction during payment verification and immediate restoration of scrolling capability
